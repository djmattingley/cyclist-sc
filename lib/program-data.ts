import type { Exercise, BlockData } from './types'

export const SC_EX: Record<string, Exercise> = {
  // MOBILITY
...
export const SC_GYM_SWAPS: Record<string, string> = {
  rdl:           'trapBarDL',
...
export const SC_SYSTEM_PROMPT = `You are a cycling-specific strength & conditioning coach.
...
export const SC_BLOCKS: BlockData[] = [
  // ═══ BLOCK 1 ═══
  {
  ...
  // ═══ BLOCK 2 ═══
  {
    ...
    weeks: [
      ...
      { n: 7, theme: "Overload", rpe: "6", color: "amber",
        ...
        blocks: [
          { name: "Mobility & Prep", dur: "4 min", cat: "mobility", exercises: [
            { ex: "hip9090", sets: null, reps: "75 s", note: "Extra time in tight spots" }, { ex: "worldGreatest", sets: null, reps: "6/side", note: null },
            { ex: "heelDrop", sets: null, reps: "10/side", note: null }, { ex: "thoracicRot", sets: null, reps: "6/side", note: null }] },
          { name: "Power Prep", dur: "5 min", cat: "power-prep", exercises: [
